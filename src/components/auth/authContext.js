...
const clientId =
  "1054215992701-98tvjeo21v3j95gi3ok03m6637kvafv8.apps.googleusercontent.com";
    ...
    onFailure: (err) => {
      ...
      const details = {
        idpiframe_initialization_failed:
          "Initialization of the Google Auth API failed. (You might haven't enabled  third party cookies in your browser.)",
      ...
      globalContext.showSnackBar(
        `${String(err.error).toUpperCase()}: ${details[err.error]}`,
        {
          variant: "error",
          transition: "slideRight",
        }
